...
// Strict TS-safe (noImplicitAny): all callback params are typed.
...
// Strict typing here prevents TS7006
...
export function applyPacksToPersist(packs: IcnBulkPackV1[]): ApplyResult {
  ...
  // Typed callback params (no TS7006)
  ...
  for (const part of partsAll) {
    ...
    // Unknown dataset -> store under state.imports
